...
import gov.nist.registry.common2.exception.HttpClientException;
import gov.nist.registry.common2.exception.HttpCodeException;
import gov.nist.registry.common2.exception.XdsInternalException;
import gov.nist.registry.common2.httpclient.HttpClient;
	...
	ParserConfigurationException, SAXException, MessagingException {
		...
		if (document1 != null) {
			try {
				...
				throw new HttpClientException("HttpClientBean: Unable to attach document: " + e.getMessage());
			}
		}
		sl.basic_call();
