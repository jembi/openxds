...
public class FindDocuments extends StoredQuery {
	...
	public FindDocuments(ErrorLogger response, Message log_message) {
		super(response, log_message);
	}

	public FindDocuments(HashMap params, boolean return_objects, Response response, Message log_message, boolean is_secure) throws MetadataValidationException {
	...
	public Metadata run_internal() throws XdsInternalException, XdsException, LoggerException, XDSRegistryOutOfResourcesException {
